...
class BoardGameTest < Minitest::Test
  ...
  # def test_board_game_box_has_image_url
  #   TOPICS.each do |t|
  #     assert BoardGame.new(t).game_box.image_url, msg: "Topic was '#{t}'"
  #   end
  # end

  # def test_board_game_has_correct_number_of_game_pieces
  #   TOPICS.each do |t|
  #     assert_equal BoardGame.new(t).game_pieces.count, GamePieces::NUMBER_OF_PIECES, msg: "Topic was '#{t}'"
  #   end
  # end

  # def test_board_game_pieces_all_have_names
  #   TOPICS.each do |t|
  #     assert BoardGame.new(t).game_pieces.map { |gp|
  #       gp.name.is_a?(String) && !gp.name.empty?
  #     }.all?, msg: "Topic was '#{t}'"
  #   end
  # end

  def test_board_game_pieces_all_have_image_urls
    TOPICS.each do |t|
      assert BoardGame.new(t).game_pieces.map { |gp|

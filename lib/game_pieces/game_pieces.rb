class GamePieces
  ...
  def retrieve_game_pieces
    ExternalPersistentStorage.retrieve_hash(@topic, EXTERNAL_STORAGE_FILENAME).tap do |i, game_piece_name|
  ...
  def generate_game_pieces
    ...
    {}.tap do |game_pieces|
      proper_noun_entities.each do |e|
        break if game_pieces.count == NUMBER_OF_PIECES
